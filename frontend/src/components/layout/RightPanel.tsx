...
export default function RightPanel() {
  ...
  return (
    <aside
      ...
      className="hidden xl:flex xl:flex-col xl:w-72 xl:fixed xl:top-14 xl:bottom-0 xl:right-0 xl:z-10 xl:border-l-2 xl:border-borde xl:bg-sidebar xl:px-4 xl:py-6 xl:overflow-y-auto"
    >
      {/* Perfil rápido */}
            ...
            <div className="flex-1">
              ...
              <div className="progress-bar-duo mt-1" style={{ height: 8 }}>
                <div
                  ...
                  style={{
                    width: `${(Math.min(totalCompleted, 5) / 5) * 100}%`,
                  }}
                />
              </div>
              <p className="text-[10px] text-texto-suave mt-0.5">
